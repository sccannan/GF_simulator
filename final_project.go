...
var algorithms = []string{"mGF"} //all the algorithms we want to test
...
//----------------------------------------------
func confidence_Interval(arr []float64) (float64) {
	conf := 1.95996 // 95% confidence for the mean
	dev := std(arr)/math.Sqrt(float64(len(arr)))
	return dev*conf
}
//----------------------------------------------
...
func main() {
	...
	for x := 0; x < len(algorithms); x++{
		...
		fmt.Printf("%.4v\n", confidence_Interval(temp_Latency))
		fmt.Printf("%.4v\n", confidence_Interval(temp_Size))
		fmt.Printf("%.4v%%\n", 100*confidence_Interval(temp_Packet_loss))
		fmt.Printf("%.4v\n", confidence_Interval(temp_Stretch))
		fmt.Printf("%.4v%%\n", 100*confidence_Interval(temp_Extranious_Hops))
		fmt.Printf("%.4v%%\n", 100*confidence_Interval(temp_Pressure_Percentage))
		fmt.Printf("%.4v%%\n", 100*confidence_Interval(temp_Pressure_Count))
		fmt.Printf("%.4v%%\n", 100*confidence_Interval(temp_Nodes_Visited))
